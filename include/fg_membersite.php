...
class FGMembersite
{
  ...
  function ValidateRegistrationSubmission()
    ...
    {
        $formvars['first-name'] = $this->Sanitize($_POST['first-name']);
		$formvars['last-name'] = $this->Sanitize($_POST['last-name']);
		$formvars['dob'] = $this->Sanitize($_POST['dob']);
		$formvars['email'] = $this->Sanitize($_POST['email']);
        $formvars['phone'] = $this->Sanitize($_POST['phone']);
		$formvars['zip'] = $this->Sanitize($_POST['zip']);
		$formvars['street-address'] = $this->Sanitize($_POST['street-address']);
		$formvars['city'] = $this->Sanitize($_POST['city']);
		$formvars['state'] = $this->Sanitize($_POST['state']);
		$formvars['username'] = $this->Sanitize($_POST['email']);
    ...
    function CreateTable()
    {
        $qry = "Create Table $this->tablename (".
				...
				"street-address VARCHAR( 128 ) NOT NULL ,".
    ...
    function InsertIntoDB(&$formvars)
    {
        ...
        $insert_query = 'insert into '.$this->tablename.'(
                ...
                values
                (
                "' . $this->SanitizeForSQL($formvars['first-name']) . '",
				"' . $this->SanitizeForSQL($formvars['last-name']) . '",
				"' . $this->SanitizeForSQL($formvars['dob']) . '",
                "' . $this->SanitizeForSQL($formvars['email']) . '",
				"' . $this->SanitizeForSQL($formvars['phone']) . '",
				"' . $this->SanitizeForSQL($formvars['zip']) . '",
				"' . $this->SanitizeForSQL($formvars['street-address']) . '",
